 ...
 * Console.log your result.
*/ 
var bango3 = 1, bango4 = 2, bango5 = 3;
...
var myFullName = createFullName("Alf", "Lang");
...
//var myFullName = eatFood(createFullName("Biggie", "Smalls", "Won Ton Soup"));
 ...
 *    @param Datatype: Number `inches`
 *    @return Datatype: Number
 * This function will convert inches to centimeters(cm).
 * Console.log your result. 
*/
...
*/
var input = "believe you can and you're halfway there.";
function allCaps(str) {
	return str.toUpperCase();
}
console.log(allCaps(input));
 ...
 *   @return Datatype: String
 * This function will check the value stored in the `canDrink` variable in the previous exercise. If the value is true, it will return the message "Cheee Hoo! We going to da party!" If false, then it will return the message "Meh, see you at Starbucks." Store the return value to a variable named `canParty`. Console.log your result.
 */
function throwParty() {
	if (canDrink == true) {
